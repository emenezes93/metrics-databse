...
export default function() {
  ...
  // Send metrics to Prometheus via HTTP instead of remote write
...
function sendMetricsToPrometheus() {
  // Simple HTTP check to prometheus to verify connectivity
  const promResponse = http.get('http://prometheus:9090/api/v1/label/__name__/values');
...
export function teardown() {
  console.log('Working Prometheus test completed');
}